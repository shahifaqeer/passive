...
class passiveHandler(object):
    ...
    def __init__(self, filename='/data/users/sarthak/filtered-20130401-20130414', folder='/data/users/sarthak/node_data201304/'):
        ...
        self.num_dropped_packets = defaultdict(int)
        ...
        for key, value in self.db.RangeIter():
            ...
            if decode_it:
                ...
                if 'packet_series_dropped' in trace:
                    self.num_dropped_packets[node_id, currentTime] = trace['packet_series_dropped']
...
def initialize():
    ...
    print "Dump dropped packets"
    pkl.dump(pHandle.num_dropped_packets, open(pHandle.folder + 'dropped_packets.out', 'w'))
